...
class IBMBackend(Backend):
    ...
    def add_options(cls, add_option):
        add_option("--ibm-backend", metavar="NAME", default=None,
                   help="IBM: target backend/device name (e.g. ibm_brisbane)")
        add_option("--ibm-instance", metavar="HUB/GROUP/PROJECT", default=None,
                   help="IBM: instance (hub/group/project)")
        add_option("--ibm-shots", metavar="N", default=None,
